...
{
	/// <summary>
	/// Summary description for TopViewedProducts.
	/// </summary>
	public class TopViewedProducts : System.Web.UI.Page
	{
		CSWContext _ctx;
		...
		{
			ListView lv = new ListView(_ctx, "TopViewedProducts","rpt_top_viewed_products", null, null, _ctx.LoadListViewFromSession , false);
			lv.StylePrefix = "RPT";
