<%@ Page language="c#" Codebehind="admin_deactivate.aspx.cs" AutoEventWireup="false" Inherits="Fullplay.admin_deactivate" %>
<screen type="admin_reset" admin="yes">
	...
	<layout>
		...
		<element contentid="message" align="left" bgcolor="<%=Style["SubHeadingColor"]%>">
			<font color="<%=Style["SubHeadingFontColor"]%>"><%=Style["SubHeadingFont"]%></font>
			<position left="0" top="60" width="320" height="20" />
		</element>
		<element contentid="description" align="center" bgcolor="<%=Style["DescriptionColor"]%>">
