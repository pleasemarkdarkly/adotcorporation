...
xmlns:Style="urn:fullplay-schema-com:Style">
	...
	<layout>
		...
		<list contentid="listcontent" select="single" itemheight="20" focus="true" bgcolor="255,255,255">
		...
		<element contentid="albumtext">
			<position left="30" top="90" width="200" height="20"/> 
			<font color="0,0,0">Verdana12bold</font> 
		</element>
		<element contentid="artisttext">
			<position left="30" top="110" width="200" height="20"/> 
			<font color="0,0,0">Verdana12bold</font> 
		</element>
	...
	<content id="listcontent">
		...
		<xsl:apply-templates select="Item/item/tracks"/>
	...
	<content id="artisttext">
 		<string font="Verdana12Bold"><xsl:value-of select="Item/item/artistname"/></string> 
	</content>

	<content id="albumprice">
		<string font="Verdana24Bold">$14.50</string>
	</content>
	...
	<content id="tab2">
		<xsl:choose>
			<xsl:when test="$selectedTab='2'">
				<image url="fullplay/tab_review_154_309_85_33.png" />
			</xsl:when>
			<xsl:otherwise>
				<image url="fullplay/tab_review_up_154_309_85_33.png" surl="fullplay/tab_review_down_154_309_85_33.png"/>
			</xsl:otherwise>
		</xsl:choose>
	</content>
	<content id="tab3">
		<xsl:choose>
			<xsl:when test="$selectedTab='3'">
				<image url="fullplay/tab_disc_239_309_152_33.png" />
			</xsl:when>
			<xsl:otherwise>
				<image url="fullplay/tab_disc_up_239_309_152_33.png" surl="fullplay/tab_disc_down_239_309_152_33.png" />
			</xsl:otherwise>
		</xsl:choose>
	</content>
...
<xsl:template name="placeDetailMenuContent">
	 ...
	 <element contentid="tab2">
	 	<position left="154" top="309" width="85" height="33"/> 
	 </element>
	 <element contentid="tab3">
	 	<position left="239" top="309" width="152" height="33"/> 
	 </element>	
</xsl:template>
<xsl:template match="Item/item/tracks">
		...
		<listitem>
			<cell align="left">
			 ...
			 <selected>
  			...
  			<string padding="16"><xsl:value-of select="name"/></string> 
  			</cell>
		</listitem>
	</xsl:for-each>
</xsl:template>
