...
xmlns:Style="urn:fullplay-schema-com:Style" xmlns:Ext="xslext">
	...
	<layout>
		...
		<margins top="6" bottom="4" left="6" right="7" /> 
			<cellspacing width="7" /> 
			<position left="17" top="125" width="330" height="335" /> 
	...
	<xsl:for-each select="genre">
		...
		<xsl:choose>
			...
			<xsl:when test="@idMediaType='10'">
				<link>getGames.m?idGenre=<xsl:value-of select="@idGenre"/>&amp;idmediatype=<xsl:value-of select="@idMediaType"/></link>
			</xsl:when>
