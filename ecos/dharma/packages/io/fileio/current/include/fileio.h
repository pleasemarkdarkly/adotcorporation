...
#define CYG_FILE_TYPE_NON       0       /* no type */
#define	CYG_FILE_TYPE_FILE      1	/* file */
#define CYG_FILE_TYPE_REG       CYG_FILE_TYPE_FILE
#define	CYG_FILE_TYPE_SOCKET	2	/* communications endpoint */
#define CYG_FILE_TYPE_BLK       3       /* block device */
#define CYG_FILE_TYPE_DIR       4       /* directory */
#define CYG_FILE_TYPE_LNK       5       /* soft link */
#define CYG_FILE_TYPE_CHR       6       /* character device */
