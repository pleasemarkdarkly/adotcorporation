...
// dc - if interrupt nesting is disabled, save 320 bytes of ram here
#if defined(CYGSEM_HAL_COMMON_INTERRUPTS_ALLOW_NESTING)
#define CYGNUM_HAL_MAX_INTERRUPT_NESTING 4
#else
#define CYGNUM_HAL_MAX_INTERRUPT_NESTING 0
#endif
