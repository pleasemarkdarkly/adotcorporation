...
void in_port_string(unsigned int port, char * dst, int n);
void out_port_string(unsigned int port, char * src, int n);
#define IN_PORT_STRING in_port_string
#define OUT_PORT_STRING out_port_string
#endif
