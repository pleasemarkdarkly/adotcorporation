...
void
usbs_mass_storage_init(void* mem_ptr, int len, usbs_control_endpoint* ctrl, usbs_rx_endpoint* rx, usbs_tx_endpoint* tx)
{
	usbs_mass_storage* ms = (usbs_mass_storage*) mem_ptr;
...
//    ctrl->state_change_fn       = &usbs_mass_storage_state_change_handler;
    ...
    ms->protocol_data = (void*)( (char*)mem_ptr + sizeof( usbs_mass_storage ) );
    ms->protocol_data_len = len - sizeof( usbs_mass_storage );
    
    usbs_ms_protocol_init( ms );
