...
#if defined(__DHARMA)
#define SDCONF          0x80002300
#define SDCONF_CASLAT(n)  (n)
#define SDCONF_SDSIZE(n)  (n<<5)
#define SDCONF_SDWIDTH(n) (n<<7)
#define SDCONF_CLKCTL     (1<<9)
#define SDCONF_SDACTIVE   (1<<10)

#define SDREFR          0x80002340
#define CIRBLK          0x80002400

#define UNIQID          0x80002440
#define RANDID0         0x80002700
#define RANDID1         0x80002704
#define RANDID2         0x80002708
#define RANDID3         0x8000270C

#define DAI64Fs         0x80002600
...
#define DAI64Fs_AUDDIV(n) (n<<8)

#define CBPTL2          0x80003000
#define CBPTL1          0x80004000

#define PLLW            0x80002610
#define PLLR            0x8000a5a8
#endif
