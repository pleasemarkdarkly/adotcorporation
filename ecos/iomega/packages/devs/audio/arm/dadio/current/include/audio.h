...
#ifdef MULTIBUF
# define DSP_NUM_BUFS  16
#else
# define DSP_NUM_BUFS 48
#endif
#define DSP_BUF_SIZE (1152 * 2 * 2)   /* MP3_MAX_PCM_LENGTH * sizeof(short) * num_channels */

#define DIGITAL_VOLUME
//#undef DIGITAL_VOLUME
#ifdef DIGITAL_VOLUME
/* digital volume ranges */
#define DSP_MAX_VOLUME   18
#define DSP_MIN_VOLUME  -96
#else
/* analog volume ranges */
#define DSP_MAX_VOLUME    0
#define DSP_MIN_VOLUME  -96	/* actually only goes to -25, which leaves digital volume on
				 * so use this value and turn down digital volume after analog
