...
#define CS7_CONFIG MEMCFG_BUS_WIDTH_32 | MEMCFG_WAIT_STATES(0)
    ...
    *(volatile cyg_uint32 *)MEMCFG1 = 0x00001814;
    *(volatile cyg_uint32 *)MEMCFG2 = 0x00000102;
    // Set up GPIO lines
    *(volatile cyg_uint8 *)PADDR   = 0x00;  // Keyboard data 0-7 input
    *(volatile cyg_uint8 *)PADR    = 0x00;
    *(volatile cyg_uint8 *)PBDDR   = 0x0f;  // 0 - LCD /WR
                                            // 1 - LCD DATA
                                            // 2 - DAC SDA
                                            // 3 - DAC SCL
                                            // 4 - USB suspend
    ...
    *(volatile cyg_uint8 *)PDDDR   = 0xde;  // 0 - CLK
                                            // 1 - CMD
                                            // 2 - DATA0
                                            // 3 - CARD1
                                            // 4 - CARD2
                                            ...
                                            // 6 - CMD-2
                                            // 7 - DATA0-2
    *(volatile cyg_uint8 *)LEDFLSH = 0x00;  // Turn off the LEDFLSH
    *(volatile cyg_uint8 *)PDDR    = 0x21;  // Turn on the clocks
    *(volatile cyg_uint8 *)PDDDR   = 0xfc;  // CLK0, CMD0 write, everything else read
    *(volatile cyg_uint8 *)PEDDR   = 0x07;  // 0 - VCC_MMC, active low
                                            // 1 - DAC MCLK, AMP SHUTDN
                                            // 2 - 
    *(volatile cyg_uint8 *)PEDR    = 0x01;  // MMC off, DAC off
    // Initialize system control
    *(volatile cyg_uint32 *)SYSCON2 = SYSCON2_KBWEN;
    *(volatile cyg_uint32 *)SYSCON3 |= (SYSCON3_I2SSEL | 0x0200);
#endif
