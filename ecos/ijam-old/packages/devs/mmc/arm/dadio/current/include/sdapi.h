...
typedef struct drv_geometry_desc
{
	...
	UCHAR   modelNum[32];   /* Drive model number */
...
#ifndef dev_copybuff
SDVOID dev_copybuff(SDVOID *vto, SDVOID *vfrom, INT16 size);
#endif

#ifndef dev_compbuff
INT16 dev_compbuff(SDVOID *vfrom, SDVOID *vto, INT16 size);
#endif

#ifndef dev_pc_memfill
SDVOID dev_pc_memfill(SDVOID *vto, INT16 size, UTINY c);
#endif

#ifndef dev_pc_strcat
SDVOID dev_pc_strcat(TEXT *to, TEXT *from);
#endif
...
/****************************************************************************/
	...
	#define SDREAD_DATA08(X) (inpbyte((UINT16) (X) ))
        #define SDWRITE_DATA08(X,Y) outpbyte((UINT16)(X), (UINT16)(Y))
...
*
******************************************************************************/
INT16 dev_pc_get_error (INT16 driveno_or_taskno);
