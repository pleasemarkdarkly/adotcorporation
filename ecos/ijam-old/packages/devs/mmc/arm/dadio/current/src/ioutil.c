...
SDVOID system_controller_init (INT16 driveno) /* __fn__ */
{
	...
	controller_no = dev_drno_to_controller_no(driveno);
#else
        controller_no = 0;
        driveno = driveno;
#endif
...
#if 1
/*****************************************************************************
* Name: dev_get_controller_number
*
* Description:
...
*
****************************************************************************/
INT16 dev_get_controller_number(INT16 driveno) /* __fn__ */
{
	INT16 cno;
	INT16 dd, ddd;
...
#if 1
/*****************************************************************************
* Name: dev_drno_to_controller_no 
*
...
*
******************************************************************************/
INT16 dev_drno_to_controller_no(INT16 driveno) /* __fn__ */
{
	/* Get the controller number */
	return(dev_get_controller_number(driveno));
}
#endif

#if 1
/******************************************************************************
* Name: dev_drno_to_controller
*
* Description:
...
*
******************************************************************************/
PDEVICE_CONTROLLER dev_drno_to_controller(INT16 driveno) /* __fn__ */
{
	INT16   cno;
	...
	cno = dev_get_controller_number(driveno);
	if (cno < 0)
		return(0);
...
*
******************************************************************************/
INT16 dev_drno_to_phys(INT16 driveno) /* __fn__ */
{
	INT16 cno, dd, ddd;
...
#if 0
INT16 dev_pc_get_error (INT16 driveno) /* __fn__ */
{
     return(interface_error(driveno));
}
#endif
