...
*/
#define DRIVES_PER_CONTROLLER1  1      /* DCDCDC: up to 2 at some point */
...
--------------------------------------------------------------------
*/
/* DCDCDC: switched from USE_SPI_EMULATION to USE_MMC */
...
*/
#define WORD_ACCESS_ONLY        0       /* if 1 Word accessing else Byte */
...
/*DCDCDC: #endif */
	...
	#define MMC_PRIMARY_IO_ADDRESS   0x000
	#define MMC_SECONDARY_IO_ADDRESS 0x001
