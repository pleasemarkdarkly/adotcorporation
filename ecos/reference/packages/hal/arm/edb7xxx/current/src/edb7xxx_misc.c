...
#define CS7_CONFIG MEMCFG_BUS_WIDTH_32 | MEMCFG_WAIT_STATES(0)
    ...
    *(volatile cyg_uint32 *)MEMCFG1 = 0x00000014;
    *(volatile cyg_uint32 *)MEMCFG2 = 0x00000102;
    // Set up GPIO lines
    *(volatile cyg_uint8 *)PADDR   = 0x00;  // Keyboard data 0-7 input
    *(volatile cyg_uint8 *)PBDDR   = 0x9f;  // 0 - display enable (active high)
                                            // 1 - CF reset
                                            // 2 - DAC SDA
                                            // 3 - DAC SCL
                                            // 4 - USB suspend (active low)
                                            // 5 - USB GoodLink
                                            // 6 - CF CD1 (active low)
                                            // 7 - LCD voltage enable (active low)
    *(volatile cyg_uint8 *)PBDR    = 0x80;  // PB0 low, PB7 high for LCD initialization
    *(volatile cyg_uint8 *)PDDDR   = 0x00;  // 0 - 
                                            // 1 - 
                                            // 2 - 
                                            // 3 - 
                                            // 4 - 
    ...
    *(volatile cyg_uint8 *)PEDDR   = 0x00;  // 0 - 
                                            // 1 - 
                                            // 2 - 
    *(volatile cyg_uint8 *)PEDR    = 0x00;  // everything low
