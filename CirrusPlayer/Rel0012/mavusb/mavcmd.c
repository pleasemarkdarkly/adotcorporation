...
Maverick_GetDescriptor(unsigned long ulDescriptor, unsigned long ulIndex,
                       char *pcValue, unsigned long *pulLength)
{
       ...
       sResult.ulReturnCode)
    {
        ...
        //
        memcpy(pcValue, sResult.uResults.sGetDescriptor.pcValue,
...
Maverick_SetDescriptor(unsigned long ulDescriptor, unsigned long ulIndex,
                       char *pcValue, unsigned long ulLength)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
    ...
    memcpy(sParam.uParams.sSetDescriptor.pcValue, pcValue, ulLength);
...
//****************************************************************************
unsigned long
Maverick_Open(unsigned long ulDrive, const char *pcFileName,
              unsigned long ulFlags)
{
    ...
    strcpy(sParam.uParams.sOpen.pcFileName, pcFileName);
...
//****************************************************************************
unsigned long
Maverick_Create(unsigned long ulDrive, const char *pcFileName,
                unsigned long ulFileLength)
{
    ...
    strcpy(sParam.uParams.sCreate.pcFileName, pcFileName);
...
//****************************************************************************
unsigned long
Maverick_Delete(unsigned long ulDrive, const char *pcFileName)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
    ...
    strcpy(sParam.uParams.sDelete.pcFileName, pcFileName);
...
//****************************************************************************
unsigned long
Maverick_OpenDir(unsigned long ulDrive, const char *pcDirName)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
    ...
    strcpy(sParam.uParams.sOpenDir.pcDirName, pcDirName);
...
//****************************************************************************
unsigned long
Maverick_ReadDir(char *pcFileName, unsigned long ulType)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
       ...
       sResult.ulReturnCode)
    {
        ...
        //
        strcpy(pcFileName, sResult.uResults.sReadDir.pcName);
...
//****************************************************************************
unsigned long
Maverick_MakeDir(unsigned long ulDrive, const char *pcDirName)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
    ...
    strcpy(sParam.uParams.sMakeDir.pcDirName, pcDirName);
...
//****************************************************************************
unsigned long
Maverick_RemoveDir(unsigned long ulDrive, const char *pcDirName)
{
    MavUsb_IoctlParams sParam;
    MavUsb_IoctlResults sResult;
    unsigned long ulCount, ulResult;
    ...
    strcpy(sParam.uParams.sRemoveDir.pcDirName, pcDirName);
...
//****************************************************************************
unsigned long
Maverick_GetDeviceName(char *pcBuffer, unsigned long ulLength)
{
    ...
    // Get the count of bytes transferred.
    //
    ulResult = DeviceIoControl(hFile, IOCTL_MAVUSB_GET_NAME, NULL, 0, pcBuffer,
                               ulLength, &ulCount, NULL);
