...
* The evaluation version of the Cirrus Logic SSFDC filesystem has the following
  limitations:
  - It can only access 4MB, 8MB, and 16MB NAND FLASH devices.
...
* SmartMedia cards do not always work correctly.  They may not be recognized by
  the player and therefore be unusable.  A related hardware limitation is that
  SmartMedia cards can only be hot plugged and unplugged on the EP7209
  reference design, not on the EP7209 or EP73xx evaluation boards.
...
* EP73xx evaluation board
  ...
  - Power on the board.
  - Press the "wakeup" button on the board.
  - Wait until "unformat" says it has successfully downloaded the image.
  - Power off the board.
  - Remove the jumper from JP2.
...
copy a file from the application to the clip-board.
...
* User2
  - Pressing this button will start playback of the current song, or pause if
...
* User3
  - Pressing this button will stop playback of the current song.
  - While in menu mode on the EP7209 reference design, pressing this button
    will adjust down the value of the currently selected menu item.  Holding
    this button will continue the adjustment.

* User4
  - Pressing this button will return to the beginning of this song (if the
    current time is greater than 3 seconds) or will skip to the previous song
    (if the current time is less than 3 seconds).
  - Holding this button will seek backwards within the song, if the song is
    being played or is paused, and will continue skipping to the previous song,
    if the song is not being played.
  - While in menu mode on the EP7209 reference design, pressing this button
    will move left within the menu items.  Holding this button will continue
    to move left.

* User5
  - Pressing this button will advance to the next song.
  - Holding this button will seek forwards within the song, if the song is
    being played or is paused, and will continue skipping to the next song, if
    the song is not being played.
  - While in menu mode on the EP7209 reference design, pressing this button
...
Send e-mail to epdapps@crystal.cirrus.com for assistance or further information
about the player or the additional software libraries available.
