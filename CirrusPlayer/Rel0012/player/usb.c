...
{
    unsigned char *pucReg = (unsigned char *)(HwUSBAddress + HwUSBCommand);
    int iIdx;
...
{
    unsigned char *pucReg = (unsigned char *)(HwUSBAddress + HwUSBData);
    int iIdx;
        ...
        switch(sUSB.sControlOut.bRequest & 31)
        {
            ...
            case USB_Vendor_ReadDir:
            {
                ...
                else
                {
                    ...
                    //
                    ulResult[0] = FSReadDir(&sDir, (char *)pucData,
                                            sUSB.sControlOut.wValue);
