...
} sMenuItems[] =
{
    ...
    //
#if defined(I2CADDR_CS43L43) || defined(SOFTWARE_VOLUME_CONTROL)
    ...
    // The "Space" menu item.
    //
    { "Space", DisplayValue, OutputSetSpatializerSpace, 0, 21,
    ...
    //
    { "Center", DisplayValue, OutputSetSpatializerCenter, 0, 21,
    ...
    //
    { "Speaker", DisplayStringRing, OutputSetSpatializerHeadphone,
      "0 deg\00030 deg\00060 deg\00090 deg", 4, &sUI.ulSpatializerState,
      FLAG_SPATIALIZER_SPEAKER_MASK, FLAG_SPATIALIZER_SPEAKER_SHIFT },
#endif
    ...
    // The "ViBE" menu item.
    //
    { "ViBE", DisplayValue, OutputSetSpatializerVirtualBass, 0, 21,
    ...
    // The "Color" menu item.
    //
    { "Color", DisplayStringRing, OutputSetSpatializerBassColor,
    ...
    //
    { "Loudness", DisplayValue, OutputSetSpatializerLoudness, 0, 4,
    ...
    // The "Volume" menu item.
    //
    { "Volume", DisplayValue, OutputSetSpatializerVolume, 0, 21,
    ...
    //
#if defined(I2CADDR_CS43L43) || defined(SOFTWARE_TONE_CONTROL)
...
UIInit(void)
{
    ...
    //
    sUI.ulFlags = (10 << FLAG_VOLUME_SHIFT) | FLAG_UPDATE_MENU;
