...
//****************************************************************************
unsigned long
CodecGetName(unsigned short **ppusName)
{
    //
    // If there is not a codec opened, then return an error.
    //
...
//****************************************************************************
unsigned long
CodecGetNameByIndex(unsigned long ulIndex, unsigned short **ppusName)
{
    //
...
//****************************************************************************
unsigned long
CodecGetArtist(unsigned short **ppusName)
{
    //
    // If there is not a codec opened, then return an error.
    //
...
//****************************************************************************
unsigned long
CodecGetTitle(unsigned short **ppusName)
{
    //
    // If there is not a codec opened, then return an error.
    //
