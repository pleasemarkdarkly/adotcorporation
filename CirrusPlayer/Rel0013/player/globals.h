...
// From audible.c
//
extern void AudibleLoadMetaData(unsigned long ulDrive, char *pcFileName);
...
extern const char *AudibleGetTitle(void);
extern unsigned long AudibleGetProgramStart(void);
...
extern int strncmp(const char *pcSrc1, const char *pcSrc2, int iCount);
