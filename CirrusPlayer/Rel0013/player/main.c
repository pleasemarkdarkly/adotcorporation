...
ScanAllTracks(unsigned long ulNumTracks, unsigned long ulDrive)
{
    ...
    for(; ulDrive < FSNumDrives(); ulDrive++)
    {
        ...
        while(1)
        {
            ...
            // Open this file.
            //
            if(FSOpen(&sFile, ulDrive, cFileName, FS_OPEN_READ) == 0)
            {
                //
    ...
    //
    for(; ulNumTracks < 100; ulNumTracks++)
    {
...
MediaRemoved(void)
{
    ...
    //
    for(ulTrack = 0; ulTrack < 100; ulTrack++)
    {
        //
