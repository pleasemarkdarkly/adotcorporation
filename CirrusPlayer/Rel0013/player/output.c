...
//****************************************************************************
//
// OutputSetWidth sets the width of the stereo separation.
//
//****************************************************************************
void
OutputSetWidth(long lWidth)
{
    //
    ...
    //
    SRSAdjustWidth(&(sOutput.sSRS), 0xccccccc * lWidth);
#endif
    ...
    //
    QSoundAdjustWidth(&(sOutput.sQSound), 0xccc * lWidth);
#endif
}

//****************************************************************************
//
// OutputSetTruBass sets the amount of TruBass enhancement.
//
//****************************************************************************
void
OutputSetTruBass(long lBass)
{
#ifdef SUPPORT_SRS
    //
    ...
    //
    // Adjust the TruBass enhancement of the SRS processing.
    //
    SRSAdjustTruBass(&(sOutput.sSRS), 0xccccccc * lBass);
#endif
}
