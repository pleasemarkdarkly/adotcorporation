//****************************************************************************
//
// INTELC3.C - Routines for programming Intel C3 FLASH-es.
//
...
//****************************************************************************
//
// Only include these routines if we are using an Intel C3 FLASH.
//
//****************************************************************************
           ...
           unsigned long bIs16BitWide)
{
    ...
    for(ulOffset = 0; ulOffset <= ulLength; )
    {
        ...
        if(bIs16BitWide)
        {
            ...
            // Unlock this block.
            //
            pusPtr[(ulBase + ulOffset) >> 1] = 0x0060;
        ...
        else
        {
            ...
            // Unlock this block.
            //
            pulPtr[(ulBase + ulOffset) >> 2] = 0x00600060;
