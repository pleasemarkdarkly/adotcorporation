              ...
              unsigned long ulParam4)
{
    ...
    switch(ulIoctl)
    {
        ...
        case IOCTL_CODEC_QUERY:
        {
            ...
            //
            if((pucScratch[0] != 'R') || (pucScratch[1] != 'I') ||
               (pucScratch[2] != 'F') || (pucScratch[3] != 'F'))
            {
                return(0);
            }
            ...
            // "WAVE".
            //
            if((pucScratch[8] != 'W') || (pucScratch[9] != 'A') ||
               (pucScratch[10] != 'V') || (pucScratch[11] != 'E'))
            {
                return(0);
            }
            ...
            //
            if((pucScratch[12] != 'f') || (pucScratch[13] != 'm') ||
               (pucScratch[14] != 't') || (pucScratch[15] != ' '))
            {
                return(0);
            }
            ...
            //
            if((pucScratch[20] != 0x30) || (pucScratch[21] != 0x01))
            {
                return(0);
            }
            ...
            //
            if((pucScratch[54] != 'd') || (pucScratch[55] != 'a') ||
               (pucScratch[56] != 't') || (pucScratch[57] != 'a'))
            {
                return(0);
            }
        ...
        case IOCTL_CODEC_OPEN:
        {
            ...
            //
            if((ulParam1 + sizeof(tANET)) > ulExtentOfRAM)
            {
                return(0);
            }
        ...
        case IOCTL_CODEC_CAN_DECODE:
        {
            ...
            //
            if(BufferSpaceAvailable(pANET->pOutput) <
