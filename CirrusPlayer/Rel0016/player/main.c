...
ScanAllTracks(unsigned long ulNumTracks, unsigned long ulDrive)
{
    ...
    for(; ulDrive < FSNumDrives(); ulDrive++)
    {
        ...
        while(1)
        {
            ...
            {
                //
                // Get the number of the codec that decodes this file.
                //
...
entry(void)
{
    ...
    while(1)
    {
        ...
        {
            //
            // Delay for a little bit to make sure that the card is fully
            // inserted.
            //
            for(ulButtons = 0; ulButtons < 262144; ulButtons++)
            {
            }
