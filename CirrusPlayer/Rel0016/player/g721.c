          ...
          unsigned long ulParam4)
{
    ...
    switch(ulIoctl)
    {
        ...
        case IOCTL_CODEC_QUERY:
        {
            ...
            //
            // The third parameters is a 512 byte scratch buffer.
            //
            ...
            //
            if((pucScratch[0] != 'G') || (pucScratch[1] != '7') ||
               (pucScratch[2] != '2') || (pucScratch[3] != '1'))
            {
                return(0);
            }
        ...
        case IOCTL_CODEC_OPEN:
        {
            ...
            //
            if(((unsigned long)pG721 + sizeof(tG721)) > ulExtentOfRAM)
            {
                return(0);
            }
        ...
        case IOCTL_CODEC_CAN_DECODE:
        {
            ...
            //
            if(BufferSpaceAvailable(pG721->pBuffer) < 256)
            {
                //
        ...
        case IOCTL_CODEC_DECODE:
        {
            ...
            //
            // Zero-pad the remainder of the 256 sample buffer.
            //
            for(; lLoop < 256; lLoop += 2)
            {
                *psLeft++ = 0;
                *psLeft++ = 0;
            }
            ...
            //
            BufferUpdateWritePointer(pG721->pBuffer, 256);
        ...
        case IOCTL_CODEC_CAN_ENCODE:
        {
            ...
            //
            if(BufferDataAvailable(pG721->pBuffer) < 256)
            {
                //
